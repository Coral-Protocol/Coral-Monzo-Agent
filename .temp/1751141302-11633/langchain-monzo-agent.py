...
async def create_monzo_agent(client, tools):
    prompt = ChatPromptTemplate.from_messages([
        ...
        1. Call `user-input` to create a box and request query from user.
        ...
        7. Always respond back to the user by calling `user-input` even if you have no answer or error.
